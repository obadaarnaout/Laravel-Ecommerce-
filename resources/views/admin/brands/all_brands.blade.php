				    ...
				    <div class="box">
				       ...
				       <div class="box-body">
				          <div class="table-responsive">
				             <table id="brands_table" class="table table-bordered table-striped">
				                <thead>
				                   <tr>
				                      <th>Name</th>
				                      <th>Image</th>
				                ...
				                <tbody>
				                   ...
				                   <tr>
				                      <td>{{$brand->name}}</td>
				                      <td><img src="{{url($brand->image)}}" width="50px;" height="50px;"></td>
				                      <td>
				                      	<a href="{{route('edit_brand',$brand->id)}}" class="btn btn-info">Edit</a>
				...
				<div class="col-4">
				    <div class="box">
				       ...
				       <div class="box-body">
				          <div class="row">
		                     <div class="col">
		                        <form novalidate id="add_admin_brand_form" enctype="multipart/form-data" method="POST">
		                           <div id="add_admin_brand_form_alert"></div>
		                           <div class="row">
		                              <div class="col-12">
		                           ...
		                           <div class="text-xs-right">
		                              <br>
		                              <button type="submit" class="btn btn-rounded btn-info" id="add_admin_brand_btn">Add</button>
		                           </div>
		                        </form>
		                     </div>
		                     <!-- /.col -->
